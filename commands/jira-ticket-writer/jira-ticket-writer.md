...
description: >
  ...
  well-structured, Jira-compatible tickets (Bug, Story, or Task). Use this skill whenever
  a user pastes a Slack message, bug report, feature request, or intake form and wants
  it turned into a Jira ticket. Trigger on phrases like "write a Jira ticket",
  "create a ticket from this", "turn this into a Jira issue", "draft a story/bug/task",
  or when someone shares a Slack message or form submission and asks for help capturing
  it in Jira. Even if the user doesn't say "Jira" explicitly — if they want to convert
  a Slack message or intake form into a structured issue or ticket, use this skill.
  Always draft first for human review, then offer to create directly in Jira.
---
...
review first, then offers to submit directly to Jira.
...
### Step 5 — Present Draft & Offer to Create in Jira
...
> - When you're happy with it, say **"create it"** and tell me the **Jira project key** (e.g. `ENG`, `PLAT`) and I'll submit it directly.
